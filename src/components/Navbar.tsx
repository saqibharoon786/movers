...
const services = [
  { icon: Car, label: "Pet Relocation Services", slug: "pet-relocation" },
  { icon: FileCheck, label: "Cargo Insurance Services", slug: "cargo-insurance" },
  { icon: Ship, label: "International Freight Forwarding", slug: "freight-forwarding" },
  { icon: Truck, label: "Door-to-Door Cargo Services (China to Pakistan)", slug: "china-to-pakistan-cargo" },
  { icon: MapPin, label: "Nationwide Distribution Services", slug: "nationwide-distribution" },
  { icon: Package, label: "Packing Materials Supply", slug: "packing-materials" },
