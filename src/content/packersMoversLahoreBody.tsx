...
const SECTIONS: { h2: string; paras: string[] }[] = [
  ...
  {
    h2: "Pricing and surveys",
    paras: [
      "Quotes reflect cubic volume, walking distance to truck, stairs, specialty items, packing tier, and time windows. We itemise labour, materials, transport, and optional insurance. If you need to cap spend, we can propose phased packing or client-packed clothes with professional kitchen handling.",
    ],
  },
  {
    h2: "International moves starting from Lahore",
    paras: [
      "Lahore exports personal effects to GCC, UK, EU, USA, and Canada daily. Our packers prepare inventories that align with customs questioning abroad. Pair this page with our sea freight and air freight service desks plus customs clearance support for door-to-port or door-to-door planning.",
    ],
  },
  {
    h2: "Moving day in Lahore: traffic, timing, and coordination",
    paras: [
      "Ring Road openings and perpetual construction on key arteries mean the fastest map route is not always the truck-safe route. Our dispatchers factor axle loads, low bridges near Old City edges, and school rush windows around Johar Town and Model Town when scheduling second trips.",
      "Loading in Gulberg high-rises may require basement coordination with building management; Bahria Town moves might need internal security stickers on vehicles. We build slack into ETAs because Lahore punishes optimistic schedules.",
    ],
  },
  {
...
export function PackersMoversLahoreBody() {
  return (
    <>
